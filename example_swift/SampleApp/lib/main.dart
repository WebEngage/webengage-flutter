...
import 'package:webengage_plugin_example/AttributeWidget.dart';
            ...
            children: <Widget>[
              ...
              new ListTile(
                ...
                onTap: () {
                  ...
                  WebEngagePlugin.userLogin("mk_ios");
                  showToast("Login - mk_ios");
                },
              ),
              new ListTile(
                title: Text("Logout"),
              ...
              //     Navigator.push(context, MaterialPageRoute(builder: (context) => AttributeWidget()));
