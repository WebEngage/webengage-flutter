...
class MethodChannelWebEngageFlutter extends WebEngageFlutterPlatform {
  ...
  void setUpInAppCallbacks(
    ...
    onInAppPrepared = onInAppPrepared;
  }
  ...
  Future<void> setUserEmail(String email) async {
    return await _methodChannel.invokeMethod(METHOD_NAME_SET_USER_EMAIL, email);
  }
  ...
  Future<void> setUserPhone(String phone) async {
    return await _methodChannel.invokeMethod(METHOD_NAME_SET_USER_PHONE, phone);
  }

  @override
  Future<void> startGAIDTracking() async {
    return await _methodChannel.invokeMethod(METHOD_NAME_START_GAID_TRACKING);
  }
  ...
  Future<void> trackEvent(String eventName,
    ...
    return await _methodChannel.invokeMethod(METHOD_NAME_TRACK_EVENT,
  ...
  Future<void> trackScreen(String eventName,
    ...
    return await _methodChannel.invokeMethod(METHOD_NAME_TRACK_SCREEN,
  ...
  Future<void> setSecureToken(String userId, String secureToken) async {
    return await _methodChannel.invokeMethod(METHOD_NAME_SET_SECURE_TOKEN,
        {USERID: userId, SECURE_TOKEN: secureToken});
  }

  @override
  Future<void> userLogout() async {
    return await _methodChannel.invokeMethod(METHOD_NAME_SET_USER_LOGOUT);
  }
}
